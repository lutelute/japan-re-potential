...
COLOUR_MAP = {
    ...
    0: (0, 0, 0, 0),
    1: (220, 20, 60, 255),     # crimson  1-19
    20: (255, 140, 0, 255),    # darkorange 20-39
    40: (218, 165, 32, 255),   # goldenrod 40-59
    60: (34, 139, 34, 255),    # forestgreen 60-79
    80: (0, 100, 0, 255),      # darkgreen 80-100
}
